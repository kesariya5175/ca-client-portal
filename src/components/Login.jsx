  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        background: 'linear-gradient(135deg, #0f2557 0%, #1a3a7c 40%, #0d5c63 100%)',
      }} />
      ...
      {[
        ...
        <div key={i} style={{
          ...
          fontSize: f.size, opacity: f.op, pointerEvents: 'none',
          userSelect: 'none',
        }}>{f.icon}</div>
      ))}
                ...
                <form onSubmit={handleSubmit}>
                  <div className="form-group">
                    ...
                    <div style={{ position: 'relative' }}>
                      <span style={{ position: 'absolute', left: 12, top: '50%', transform: 'translateY(-50%)', color: 'var(--gray-400)', fontSize: 16 }}>✉</span>
                      <input
                  ...
                  <div className="form-group">
                    ...
                    <div style={{ position: 'relative' }}>
                      ...
                      <button type="button"
                        ...
                        style={{ position: 'absolute', right: 12, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', color: 'var(--gray-400)', fontSize: 16, padding: 0 }}>
                        {showPass ? '🙈' : '👁'}
                      </button>
                    </div>
                  </div>
                  ...
                  <button type="submit" className="btn btn-primary"
                    style={{ width: '100%', justifyContent: 'center', padding: '13px', fontSize: 16, fontWeight: 700, borderRadius: 10, marginBottom: 4 }}
                    disabled={loading}>
